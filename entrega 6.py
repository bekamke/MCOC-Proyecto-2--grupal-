...
if reuse_initial_condition:
    ...
    x0 = data["x0"]    #posición en x
    y0 = data["y0"]    #posición en y
...
zk = zeros((4*Nparticulas)) #guardar paso zk
zkm1 = zeros((4*Nparticulas)) #guardar paso zkm1
...
fout_parametros["au_star"] = au_star
fout_parametros["R"] = R
...
if doit:
    while dt*k < int(tmax/dt - 1)*dt:
        ...
        #en cada paso de tiempo se guarda el estado de cada partícula
...
print "timepo_bloque_2: ", tiempo_bloque_2
print "tiempo total: ", end - start

print "Tiempo de escritura es {}\% del tiempo total.", format(tiwmpo_bloque_1/(end - start) * 100)
